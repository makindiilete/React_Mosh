/*What we want to do here is to display a paragraph "There are no movies in the database if the array is empty" without table else we render a paragraph and the table*/
